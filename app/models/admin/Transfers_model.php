...
class Transfers_model extends CI_Model
{
    ...
    public function getTransferByID_1($id)
    {
        if (empty($id)) {
            log_message('error', 'ID is empty in getTransferByID_1');
            return false;
        }
        ...
        $this->db->select('
            ...
            purchase_items.quantity as cantidad, 
        ...
        if ($query->num_rows() > 0) {
            return $query->result(); // Devuelve los registros relacionados como un array de objetos
        }

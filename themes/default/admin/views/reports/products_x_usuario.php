...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getProducts_x_usuario_Report/?v=1' . $v) ?>',
            ...
            "aoColumns": [null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": spb}, {"mRender": spb}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, null],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var pq = 0, sq = 0, bq = 0, pa = 0, sa = 0, ba = 0, pl = 0, ca =0, pr =0, v = 0, b = 0;
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    v  += parseFloat(aaData[aiDisplay[i]][2]);
                    ca += parseFloat(aaData[aiDisplay[i]][3]);
                    pr += parseFloat(aaData[aiDisplay[i]][4]);
                    pl += parseFloat(aaData[aiDisplay[i]][7]);
                    b  += parseFloat(aaData[aiDisplay[i]][8]);
                    

                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[2].innerHTML = currencyFormat(parseFloat(v  ));
                nCells[3].innerHTML = currencyFormat(parseFloat(ca  ));
                nCells[4].innerHTML = currencyFormat(parseFloat(pr  ));
                nCells[5].innerHTML = '<div class="text-right">('+formatQuantity2(pq)+') '+formatMoney(pa)+'</div>';
                nCells[6].innerHTML = '<div class="text-right">('+formatQuantity2(sq)+') '+formatMoney(sa)+'</div>';
                nCells[7].innerHTML = currencyFormat(parseFloat(pl  ));
                nCells[8].innerHTML = currencyFormat(parseFloat(b  ));              
            }
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('reports/products_x_usuario', 'autocomplete="off"'); ?>
                    <div class="row">
                        <div class="col-sm-4">
                ...
                <div class="table-responsive">
                    <table id="PrRData"
                        ...
                        <tr class="active">
                            ...
                            <th><?= lang('cost'); ?></th>
                            <th><?= lang('price'); ?></th>  
                            <th><?= lang('Total Costo'); ?></th>
                            <th><?= lang('Total Vendido'); ?></th>
                            <th><?= lang('Utilidad'); ?></th>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('reports/getProducts_x_usuario_Report/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('reports/getProducts_x_usuario_Report/0/xls/?v=1' . $v)?>";
            return false;
        });

                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="mm_transfers">
                                ...
                                <ul>
                                    ...
                                    <li id="transfers_index_1">
                                        <a class="submenu" href="<?= admin_url('transfers/index_1'); ?>">
                                            <i class="fa fa-star-o"></i><span class="text"> <?= lang('Productos Transferidos'); ?></span>
                                        </a>
                                    </li>
                                    <li id="transfers_add">
                            ...
                            <li class="mm_reports">
                                ...
                                ?>
                                    ...
                                    <li id="reports_products">
                                        <a href="<?= admin_url('reports/products_x_usuario') ?>">
                                            <i class="fa fa-barcode"></i><span class="text"> <?= lang('Reporte de ganancia'); ?></span>
                                        </a>
                                    </li>
